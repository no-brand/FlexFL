...
public class CorpusPreprocessor {
  ...
  public static String FILE_NAME_LIST_OF_STOP_WORDS = "scripts/StopwordsPlusJava.txt";
  ...
  protected static Logger logger = Logger.getLogger(CorpusPreprocessor.class);
  ...
  public CorpusPreprocessor(String inputFileNameCorpus, String outputFolder) {
    ...
    logger.info("inputFileNameCorpus=" + inputFileNameCorpus);
    logger.info("inputFileNameCorpusWithoutPath=" + this.inputFileNameCorpusWithoutPath);
    logger.info("inputFileNameCorpusExtension=" + this.inputFileNameCorpusExtension);
    logger.info("inputFileNameCorpusWithoutPathWithoutExtension=" + this.inputFileNameCorpusWithoutPathWithoutExtension);
